...
public class MenuPeliculas extends JFrame {
	...
	private static DefaultListModel<Pelicula> modelList;
	/**
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					modelList = new DefaultListModel<Pelicula>();
	...
	public MenuPeliculas() {
		...
		mntmAgregar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				panel.setDefaultListModel(modelList);
		...
		mntmListar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				panelListar.setDefaultListModel(modelList);
